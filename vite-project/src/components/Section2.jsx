    ...
    <div className="section2" id="section2">
      ...
      >
        ...
        <p className="section2-text">
          ...
          And now here we are… talking, laughing, sharing random thoughts like we’ve known each other longer than we actually have and how can we forget you calling me 'Cringe' whenever I share a random reel in my IG feed with you (which means that IG wants us to tease each other, more! :P) Not bad for two strangers who met on Hinge randomly. 
          And someone was too busy that they responded to my text after 2 days of being matched, i.e. on 3rd February 2026, I still remember the day! :( <br>
